...
public class WaveLoadingView extends View {
    ...
    private String textFontFromAsset;
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        textFontFromAsset = attributes.getString(R.styleable.WaveLoadingView_wlv_textFontFromAsset);
        setTextFontFromAsset(textFontFromAsset);
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (mWaveShader != null) {
            ...
            if (!TextUtils.isEmpty(mTopTitle)) {
                if (textFontFromAsset != null && !textFontFromAsset.isEmpty()) {
                    if (!textFontFromAsset.contains("fonts")) {
                        textFontFromAsset = "fonts/" + textFontFromAsset;
                    }

//                    Typeface typeface = Typeface.createFromAsset(mContext.getAssets(), textFontFromAsset);
//                    mTopTitleStrokePaint.setTypeface(typeface);
//                    mTopTitlePaint.setTypeface(typeface);
                }

                float top = mTopTitlePaint.measureText(mTopTitle);
                // Draw the stroke of top text
                canvas.drawText(mTopTitle, (getWidth() - top) / 2, getHeight() * 4 / 10.0f, mTopTitleStrokePaint);
                // Draw the top text
...
//                    Typeface typeface = Typeface.createFromAsset(mContext.getAssets(), textFontFromAsset);
//                    mCenterTitleStrokePaint.setTypeface(typeface);
...
//        mWaveShader = null;
    ...
    public void setTextFontFromAsset(String textFontFromAsset) {
        this.textFontFromAsset = textFontFromAsset;
    }

    public String getTextFontFromAsset() {
        return textFontFromAsset;
    }
